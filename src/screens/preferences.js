    ...
    return (
        <ScrollView style={[styles.mainwrapper, { backgroundColor: themeMode.background }]}>
            ...
            <View style={styles.headwrapper}>
                ...
                <Text style={[styles.headtxt, { color: themeMode.text }]}>Preferences</Text>

            </View>
            <TouchableOpacity onPress={() => navigation.navigate('Personal')}>
                <Text style={{ color: themeMode.text, marginTop: 80, alignSelf: 'center' }}>Personal Preference</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Story')}>
                <Text style={{ color: themeMode.text, marginTop: 100, alignSelf: 'center' }}>Add story</Text>
            </TouchableOpacity>
        </ScrollView>
    );
};
